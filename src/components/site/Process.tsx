...
const steps = [
  {
    ...
    desc: `Collecting comprehensive data from tower owners, clients, and tower manufacturers, including technical specifications, structural details, site conditions, and high-resolution photographs. This information helps ensure accurate analysis, efficient project planning, and reliable engineering assessments tailored to real-world tower infrastructure requirements.`,
  },
  {
    icon: LineChart,
    title: "Analysis",
...
const IconBox = ({ Icon }) => (
  <div className="relative grid place-items-center shrink-0">
    ...
    <div className="group relative grid h-14 w-14 lg:h-20 lg:w-20 place-items-center rounded-2xl border border-border bg-blue-900 shadow-[var(--shadow-card)] transition-all duration-300 hover:border-yellow-600">
      <Icon size={22} className="text-white transition-colors duration-300 group-hover:text-yellow-600 lg:hidden" />
      <Icon size={28} className="text-white transition-colors duration-300 group-hover:text-yellow-600 hidden lg:block" />
    </div>
  </div>
);
              ...
              return (
                ...
                >
                  ...
                  <div className={`lg:px-12 ${isRight ? "lg:text-left" : "lg:text-right"}`}>
                    ...
                    {/* Heading row — icon inline on mobile, hidden on desktop */}
                    <div className="mt-3 flex items-center gap-3 lg:block">
                      ...
                      <h3 className="font-display text-2xl font-semibold md:text-3xl text-foreground">
                        {step.title}
                      </h3>
                    </div>
                  ...
                  <div className="relative hidden lg:grid place-items-center lg:px-12">
                    <IconBox Icon={Icon} />
                  </div>
                </motion.div>
              );
